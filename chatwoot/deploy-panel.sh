...
curl -fL -o "$HTML/coupon_lib.php" "$BASE/coupon_lib.php"
curl -fL -o "$HTML/coupon-api.php" "$BASE/coupon-api.php"
curl -fL -o "$HTML/coupon.php" "$BASE/coupon.php"
curl -fL -o "$HTML/buy.php" "$BASE/buy.php"
curl -fL -o "$HTML/renew.php" "$BASE/renew.php"
