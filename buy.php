...
let payGuideStep = 1;
const payGuidePages = [
    '<b>مبلغ کپی شد.</b> برای تکمیل خرید این کارها را انجام دهید:<br><br>' +
    ...
    '۴. بعد از واریز، معمولاً ظرف چند ثانیه پرداخت تأیید می‌شود و اشتراک شما خودکار ساخته می‌شود.',
    'نیازی نیست تا پایان در این صفحه بمانید؛ اگر صفحه را ببندید هم مشکلی نیست.<br><br>' +
    'برای دیدن لینک اشتراک، از داشبورد وارد بخش <b>اشتراک‌های من</b> شوید.'
];
