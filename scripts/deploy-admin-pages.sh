...
ROOT="${1:-/var/www/html}"
COMMIT="${DEPLOY_COMMIT:?Set DEPLOY_COMMIT to the git SHA (e.g. export DEPLOY_COMMIT=abc1234)}"
BASE="https://raw.githubusercontent.com/mr-BigJay/pnv-panel/${COMMIT}"

echo "Deploying admin payments/renews fix to $ROOT (commit $COMMIT)"
...
echo "Done. Hard-refresh admin and open:"
echo "  /bigjay_controller/?page=payments"
echo "  /bigjay_controller/?page=renews"
