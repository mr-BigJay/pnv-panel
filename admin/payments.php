...
.statusIcon.is-progress{background:#3b82f6}
...
$statusMeta = instantPayAdminRowStatusMeta($p);
$statusTitle = $statusMeta['title'] ?? $statusTitle;

switch($statusMeta['class'] ?? ''){
...
<?php } elseif($statusClass === 'is-progress'){ ?>
<span class="statusIcon is-progress" title="<?php echo htmlspecialchars($statusTitle, ENT_QUOTES, 'UTF-8'); ?>" aria-label="<?php echo htmlspecialchars($statusTitle, ENT_QUOTES, 'UTF-8'); ?>">
<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><path d="M12 8v4l2.5 1.5"/></svg>
</span>
<?php } else { ?>
<span class="statusIcon is-pending" title="<?php echo htmlspecialchars($statusTitle, ENT_QUOTES, 'UTF-8'); ?>" aria-label="<?php echo htmlspecialchars($statusTitle, ENT_QUOTES, 'UTF-8'); ?>">
...
function showAction(id,user,mobile,config,status,savedLink,track){
...
'<input type="hidden" name="approve_username" value="'+user+'">'+
'<input type="hidden" name="approve_tracking" value="'+track+'">'+
...
'<input type="hidden" name="reject_username" value="'+user+'">'+
'<input type="hidden" name="reject_tracking" value="'+track+'">'+
