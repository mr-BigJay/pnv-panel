...
$sessionFile = __DIR__ . '/../db/bale_user_session.bale';
$sessionReady = file_exists($sessionFile) && filesize($sessionFile) > 8;
$parserVersion = baleParserVersion();
...
<div class="steps">
<b>حالت فوروارد دستی:</b><br>
۱. در بله به بازو <b>/start</b> بزنید و Webhook را ثبت کنید<br>
۲. پیام واریز <b>@postbank_bot</b> را به بازو <b>فوروارد</b> کنید<br><br>
<b>حالت تمام‌اتوماتیک (Listener پایتون):</b><br>
Listener روی <b>همان اکانت بله صاحب کارت</b> اجرا می‌شود، پیام پست‌بانک را می‌خواند، به پنل می‌فرستد و به بازو فوروارد می‌کند.<br>
وضعیت سشن Listener: <?php echo $sessionReady ? '✅ آماده' : '⛔ هنوز لاگین نشده'; ?><br>
نسخه parser: <code><?php echo htmlspecialchars($parserVersion, ENT_QUOTES, 'UTF-8'); ?></code>
</div>
...
شناسه چت همان اکانت را هم در «شناسه چت مدیر» ذخیره کنید (برای فوروارد خودکار به بازو).
</div>
