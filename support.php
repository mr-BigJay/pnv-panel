...
<link rel="stylesheet" href="support_ui.css?v=35">
...
<?php echo supportRenderConvAvatarHtml($user); ?>
...
<script src="support_ui.js?v=35"></script>
<script>
(function(){
    ...
    SupportUI.bindComposerFocus(messageInput, userSupportForm);
